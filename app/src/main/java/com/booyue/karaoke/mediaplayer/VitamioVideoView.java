 ...
 */
public class VitamioVideoView extends SurfaceView implements io.vov.vitamio.widget.MediaController.MediaPlayerControl {
        ...
        public boolean onError(MediaPlayer mp, int framework_err, int impl_err) {
            ...
            if (getWindowToken() != null) {
                int message = framework_err == MediaPlayer.MEDIA_ERROR_NOT_VALID_FOR_PROGRESSIVE_PLAYBACK ? getResources().
                        ...
                        getIdentifier("VideoView_error_text_invalid_progressive_playback", "string",

                                mContext.getPackageName()) : getResources().getIdentifier

                        ("VideoView_error_text_unknown", "string", mContext.getPackageName());

                new AlertDialog.Builder(mContext).setTitle(getResources().getIdentifier

                        ("VideoView_error_title", "string", mContext.getPackageName())).

                        setMessage(message).setPositiveButton(getResources().getIdentifier
...
//                        if (mOnCompletionListener != null)
//                            mOnCompletionListener.onCompletion(mMediaPlayer);
                                if (mOnVideoErrorListener != null) {
                                    mOnVideoErrorListener.onVideoError();
                                }
                            }
    ...
    public void setVideoLayout(int layout, float aspectRatio) {
        ...
        float videoRatio = aspectRatio <= 0.01f ? windowRatio : aspectRatio;
        ...
        /**modify by : 2018/4/19 19:59*/
//        lp.topMargin = (int) getResources().getDimension(R.dimen.dimen_video_margin);
//        lp.width = windowWidth;
//        lp.height = windowHeight + 30;
        setLayoutParams(lp);
        getHolder().setFixedSize(mSurfaceWidth, mSurfaceHeight);
        /**modify by : 2018/4/19 19:59*/
//        getHolder().setFixedSize(windowWidth, windowHeight + 30);
//        io.vov.vitamio.utils.Log.d("VIDEO: %dx%dx%f, Surface: %dx%d, LP: %dx%d, Window: %dx%dx%f",
//                mVideoWidth, mVideoHeight, mSurfaceWidth, mSurfaceHeight,
...
//      return;
    ...
    public void setOnVideoErrorListener(OnVideoErrorListener listener) {

        mOnVideoErrorListener = listener;
    }
