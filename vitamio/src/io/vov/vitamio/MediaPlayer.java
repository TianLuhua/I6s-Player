...
public class MediaPlayer {
  ...
  public void selectTrack(int index) {
      LoggerUtils.d(TAG + "--selectTrack(int index):index = " + index);
  ...
  private void selectOrDeselectBandTrack(int index, boolean select) {
      LoggerUtils.d(TAG + "--selectOrDeselectBandTrack(int index,boolean select):index = " + index + ",select = " + select);
        if (mOutOfBandTracks != null) {
            ...
            LoggerUtils.d(TAG + "trackIndex = " + trackIndex + ",mediaFormat = " + mediaFormat.toString());
